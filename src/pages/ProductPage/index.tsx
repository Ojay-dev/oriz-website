  ...
  return (
    <DefaultLayout theme="light">
      <section className="overflow-hidden">
        <div className="mt-16 grid text-white lg:hidden">
          ...
          <div className="ml-10">
            <img src={ProductAppView} alt="app view" />
          </div>
        ...
        <div className="mx-auto mt-16 hidden grid-cols-2 items-center gap-x-10 text-white lg:grid">
          <div className="ml-auto w-10/12 2xl:max-w-[1440px]">
            <button className="mb-[33px] flex items-center gap-x-2 rounded-[333px] border border-[#F0F0F0] bg-[#F0F0F0] px-4 py-3">
              <span className="bg rounded-[166px] bg-green-100 px-[13px] py-[5px] uppercase">New</span>{" "}
              <span className="text-black">We’re live across all African Countries</span>
              <img src={RightArrowWhite} alt="forward arrow icon" />
            </button>
            ...
            <p className="my-8 max-w-[400px] font-jakarta text-base leading-10 text-[#050505]">
              with Personalised Fitness Plans for Your Unique Journey
            </p>
      ...
      <section className="bg-[#FAFAFA] py-28">
        <div className="mx-auto w-11/12 2xl:max-w-[1440px]">
          <div className="mb-14 flex flex-col justify-between gap-y-5 lg:flex-row lg:items-end">
            <div>
              <h3 className="font-duplicate-sans text-[35px] lg:text-[65px]">How Oriz Works</h3>

              <p className="font-jakarta text-base leading-loose lg:max-w-[518px] lg:text-[20px]">
                Prioritize your health and wellness with gym classes, massages, nourishing meals, and rejuvenating yoga – all accessible
                from home.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-x-6 gap-y-4 lg:mr-4 lg:flex-row">
              ...
              <button className="flex items-center justify-center rounded-xl bg-white px-9 text-base text-white lg:text-black">
                Learn More
              </button>
            </div>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col gap-y-5 rounded-[20px] bg-white px-6 py-5">
              <h4 className="font-duplicate-sans text-[32px] leading-tight lg:text-[40px]">Easy Sign Up</h4>
              <p className="text-[16px] lg:text-[20px]">
                Creating an account with Oriz is Easy! Simply register using your email or social media account and set up your profile.
              </p>
            </div>

            <div className="flex flex-col gap-y-5 rounded-[20px] bg-white px-6 py-5">
              <h4 className="font-duplicate-sans text-[32px] leading-tight lg:text-[40px]">Personalize Your Profile</h4>
              <p className="text-[16px] lg:text-[20px]">
                Share your fitness goals, preferences, and more about yourself for a personalized fitness plan.
              </p>
            </div>

            <div className="flex flex-col gap-y-5 rounded-[20px] bg-white px-6 py-5">
              <h4 className="font-duplicate-sans text-[32px] leading-tight lg:text-[40px]">Embark on Your Fitness Journey</h4>
              <p className="text-[16px] lg:text-[20px]">
                Access your personalized fitness plan, track progress, view real-time insights, and adjust as needed.
              </p>
            </div>

            <div className="flex flex-col gap-y-5 rounded-[20px] bg-white px-6 py-5">
              <h4 className="font-duplicate-sans text-[32px] leading-tight lg:text-[40px]">Discover Exclusive Deals</h4>
              <p className="text-[16px] lg:text-[20px]">
                Enjoy exclusive discounts from our partners on fitness services, wellness centers, meals, and experiences.
              </p>
            </div>

            <div className="flex flex-col gap-y-5 rounded-[20px] bg-white px-6 py-5">
              <h4 className="font-duplicate-sans text-[32px] leading-tight lg:text-[40px]">Connect with the Community</h4>
              <p className="text-[16px] lg:text-[20px]">
                Engage with experts, coaches, and users in our community. Share, compete, seek advice, and find inspiration.
              </p>
            </div>

            <div className="grid gap-x-12 gap-y-8 rounded-[20px] border-[4px] border-[#218068] bg-black px-6 py-5 text-white md:grid-cols-[1.5fr_1fr]">
              <div>
                <h4 className="font-duplicate-sans text-[32px] leading-tight lg:text-[40px]">Coming Soon on</h4>
                <p className="text-[16px] font-light lg:text-[20px]">
                  Sign up for early access, <br className="hidden md:block" /> and{" "}
                  <span className="font-semibold">Select a plan below.</span>
                </p>
              </div>

              <div className="flex flex-col gap-x-5 gap-y-3">
                <button className="flex items-center justify-center gap-x-2 rounded-xl bg-white px-3 py-[18px] text-base text-black md:justify-start">
                  <img src={Playstore} alt="Play store icon" />
                  Get on Google Play
                </button>
